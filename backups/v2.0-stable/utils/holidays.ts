...
export const URUGUAY_NATIONAL_HOLIDAYS: Holiday[] = [
  // 2024
  ...
  // Generación para 2025-2030 (Principales Nacionales)
  ...([2025, 2026, 2027, 2028, 2029, 2030].flatMap(year => [
    { date: `${year}-01-01`, name: 'Año Nuevo', type: 'national' as const },
    { date: `${year}-01-06`, name: 'Día de Reyes', type: 'national' as const },
    { date: `${year}-05-01`, name: 'Día del Trabajador', type: 'national' as const },
    { date: `${year}-06-19`, name: 'Natalicio de Artigas', type: 'national' as const },
    { date: `${year}-07-18`, name: 'Jura de la Constitución', type: 'national' as const },
    { date: `${year}-08-25`, name: 'Declaratoria de la Independencia', type: 'national' as const },
    { date: `${year}-11-02`, name: 'Día de los Difuntos', type: 'national' as const },
    { date: `${year}-12-25`, name: 'Navidad', type: 'national' as const },
  ]))
];

export const URUGUAY_HOLIDAYS_2024 = URUGUAY_NATIONAL_HOLIDAYS;

export const getHolidays = (customHolidays: Holiday[] = []): Holiday[] => {
  return [...URUGUAY_NATIONAL_HOLIDAYS, ...customHolidays].sort((a, b) =>
